...
convert -crop 2118x1860+490+200 funda_region_annotated.png funda_region_zoomed.png

convert +append funda_region_zoomed_grain_id_545.png  funda_region_zoomed_grain_id_574.png  grains_zoomed.png
